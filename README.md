...
<p align="center">
  <a href="https://goreportcard.com/report/github.com/xianleigirl/go.mongodb.org/mongo-driver"><img src="https://goreportcard.com/badge/github.com/xianleigirl/go.mongodb.org/mongo-driver"></a>
  <a href="https://pkg.go.dev/github.com/xianleigirl/go.mongodb.org/mongo-driver/mongo"><img src="etc/assets/godev-mongo-blue.svg" alt="docs"></a>
  <a href="https://pkg.go.dev/github.com/xianleigirl/go.mongodb.org/mongo-driver/bson"><img src="etc/assets/godev-bson-blue.svg" alt="docs"></a>
...
your project. This can be done either by importing packages from `github.com/xianleigirl/go.mongodb.org/mongo-driver` and having the build
step install the dependency or by explicitly running

```bash
go get github.com/xianleigirl/go.mongodb.org/mongo-driver/mongo
```

When using a version of Go that does not support modules, the driver can be installed using `dep` by running

```bash
dep ensure -add "github.com/xianleigirl/go.mongodb.org/mongo-driver/mongo"
```
...
For more advanced configuration and authentication, see the [documentation for mongo.Connect](https://pkg.go.dev/github.com/xianleigirl/go.mongodb.org/mongo-driver/mongo#Connect).
...
To use `bson.D`, you will need to add `"github.com/xianleigirl/go.mongodb.org/mongo-driver/bson"` to your imports.
